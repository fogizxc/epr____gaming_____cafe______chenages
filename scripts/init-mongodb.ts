...
const indexPlan: Record<string, Array<{ key: Record<string, 1 | -1>; options?: Record<string, unknown> }>> = {
  ...
  payments: [{ key: { provider: 1, providerPaymentId: 1 }, options: { unique: true, sparse: true } }, { key: { provider: 1, providerOrderId: 1 }, options: { unique: true, sparse: true } }, { key: { customerId: 1, membershipId: 1, idempotencyKey: 1 }, options: { unique: true, sparse: true } }, { key: { customerId: 1, fnbOrderId: 1, idempotencyKey: 1 }, options: { unique: true, sparse: true } }, { key: { customerId: 1, createdAt: -1 } }, { key: { customerId: 1, idempotencyKey: 1 }, options: { unique: true, sparse: true } }],
