...
const indexPlan: Record<string, Array<{ key: Record<string, 1 | -1>; options?: Record<string, unknown> }>> = {
  ...
  gaming_systems: [
    { key: { id: 1 }, options: { unique: true, sparse: true } },
    { key: { category: 1, status: 1 } },
  ],
  games: [
    { key: { slug: 1 }, options: { unique: true, sparse: true } },
    { key: { category: 1, isVisible: 1 } },
    { key: { title: "text" } as any },
  ],
  bookings: [
  ...
  wallet_transactions: [
    { key: { customerId: 1, createdAt: -1 } },
    { key: { idempotencyKey: 1 }, options: { unique: true, sparse: true } },
  ],
  ...
  tournament_teams: [
    { key: { tournamentId: 1, teamName: 1 }, options: { unique: true } },
    { key: { tournamentId: 1, status: 1 } },
  ],
  ...
  refunds: [{ key: { status: 1, createdAt: -1 } }],
