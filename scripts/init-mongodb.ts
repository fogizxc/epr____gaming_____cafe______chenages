...
const indexPlan: Record<string, Array<{ key: Record<string, 1 | -1>; options?: Record<string, unknown> }>> = {
  ...
  active_sessions: [{ key: { systemId: 1, status: 1 } }, { key: { customerId: 1, status: 1 } }, { key: { systemId: 1, status: 1 }, options: { unique: true, partialFilterExpression: { status: "ACTIVE" } } }, { key: { bookingId: 1, status: 1 } }],
  ...
  payments: [{ key: { provider: 1, providerPaymentId: 1 }, options: { unique: true, sparse: true } }, { key: { provider: 1, providerOrderId: 1 }, options: { unique: true, sparse: true } }, { key: { customerId: 1, membershipId: 1, idempotencyKey: 1 }, options: { unique: true, sparse: true } }, { key: { customerId: 1, createdAt: -1 } }, { key: { customerId: 1, idempotencyKey: 1 }, options: { unique: true, sparse: true } }],
  ...
  fnb_orders: [{ key: { customerId: 1, createdAt: -1 } }, { key: { status: 1, createdAt: -1 } }, { key: { idempotencyKey: 1 }, options: { unique: true, sparse: true } }],
  ...
  refunds: [{ key: { status: 1, createdAt: -1 } }, { key: { bookingId: 1, status: 1 } }, { key: { providerRefundId: 1 }, options: { unique: true, sparse: true } }],
