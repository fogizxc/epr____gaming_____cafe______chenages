...
const indexPlan: Record<string, Array<{ key: Record<string, 1 | -1>; options?: Record<string, unknown> }>> = {
  ...
  invoices: [{ key: { invoiceNumber: 1 }, options: { unique: true, sparse: true } }, { key: { customerId: 1, createdAt: -1 } }, { key: { paymentStatus: 1, createdAt: -1 } }],
  ...
  wallet_transactions: [{ key: { customerId: 1, createdAt: -1 } }, { key: { idempotencyKey: 1 }, options: { unique: true, sparse: true } }],
  ...
  refunds: [{ key: { status: 1, createdAt: -1 } }, { key: { providerRefundId: 1 }, options: { unique: true, sparse: true } }],
