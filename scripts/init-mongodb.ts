...
const indexPlan: Record<string, Array<{ key: Record<string, 1 | -1>; options?: Record<string, unknown> }>> = {
  ...
  razorpay_webhook_events: [{ key: { key: 1 }, options: { unique: true } }, { key: { receivedAt: -1 } }, { key: { status: 1, processingStartedAt: 1 } }],
  ...
  financial_ledger: [{ key: { transactionId: 1 }, options: { unique: true } }, { key: { occurredAt: -1 } }, { key: { source: 1, sourceId: 1 } }],
};
