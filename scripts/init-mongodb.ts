...
const indexPlan: Record<string, Array<{ key: Record<string, 1 | -1>; options?: Record<string, unknown> }>> = {
  ...
  invoices: [{ key: { invoiceNumber: 1 }, options: { unique: true, sparse: true } }, { key: { bookingId: 1 }, options: { unique: true, sparse: true } }, { key: { customerId: 1, createdAt: -1 } }, { key: { paymentStatus: 1, createdAt: -1 } }],
